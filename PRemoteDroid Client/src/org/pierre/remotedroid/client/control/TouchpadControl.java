...
public class TouchpadControl extends ControlType
{
	...
	public TouchpadControl(ControlActivity controlActivity)
	{
		...
		this.sensitivity = Float.parseFloat(PRemoteDroid.preferences().getString("control_touchpad_sensitivity", null));
		this.sensitivity /= this.controlActivity.getResources().getDisplayMetrics().density;
		this.acceleration = Float.parseFloat(PRemoteDroid.preferences().getString("control_touchpad_acceleration", null));
	}
